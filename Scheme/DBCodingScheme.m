...
- (void)encodeObject:(id)object withCoder:(DBCoder *)encoder
{
    ...
    if (![encoder decodeObjectForColumn:[self primaryKeyColumn]]) {
...
- (id)decodeObject:(id)object fromCoder:(DBCoder *)decoder;
{
    ...
    if (self.parentScheme) {
        DBCoder *parentDecoder = [decoder decoderForColumn:[self parentSchemeColumn] withScheme:self.parentScheme];
        object = [self.parentScheme decodeObject:object fromCoder:parentDecoder];
    }
